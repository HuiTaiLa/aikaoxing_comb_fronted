$(document).ready( function() {
  ...
  $("#saveBtn").click(function(e) {
    if(checkForm()){
      serializeForm();
      setTimeout(function(){
        savePaperFn("/examadmin/admin/paper_add_new","create");
      },500);
    }
  });
  // //传递 考试相关数据 到第三步
  ...
  //     manualInputTest("/examadmin/admin/paper_manual_add", "1");
  // });
  ...
  //     manualInputTest("/examadmin/admin/paper_manual_add", type);
  // });
  ...
  $("#previewBtn").click(function(e) {
    if(checkForm()){
      ...
      setTimeout(function(){
        ...
        window.open("/examadmin/admin/paper_preview?"+dataForm);
      },500);
    }
  });
  ...
  $("#downloadBtn").click(function(e) {
    if(checkForm()){
      ...
      setTimeout(function(){
        var dataForm = $('#subForm').serialize();
        window.open("/examadmin/admin/paper_download?"+dataForm,"","");
      },500);
    }
  });
  ...
  $("#updateBtn").click(function(e) {
    if(checkForm()){
      serializeForm();
      setTimeout(function(){
        savePaperFn("/examadmin/admin/paper/update_post","update");
      },500);
    }
  });
  //立即发布
  ...
  //空白试卷手工写入题目
  // $("#").click(function(e) {
  //    window.location.href = "/examadmin/admin/paper_manual_add";
  // });

  //留在这里
  $("#jumpToUpdate").click(function(e) {
    var id = $(this).attr("paper_id");
    window.location.href = "/examadmin/admin/paper/update/"+id;
  });
...
function showSelQuestions(obj){
  ...
  selQuestionFrame.location.href = "/baseinfo/admin/select_type?type="+selType+"&commit_ids="+commit_ids;
...
function showQuestionType(obj){
  selQuestionsTypeModal.location.href = "/baseinfo/admin/tree/tests_class2";
...
function showQuestionsType(obj){
  selQuestionsTypeModal.location.href = "/baseinfo/admin/tree/tests_multi_class";
  $("#questionsTypeModal").modal({
    backdrop:"static",
    keyboard:false
  });
...
function showDifficult(obj){
  ...
  difficultFrame.location.href = "/examadmin/admin/test/showcount?type="+questionsType+"&classification="+type;
...
function manualInputTest(url, type){
  ...
  var paperStyleName = $("#selTypeLink span").text();
  ...
  window.location.href = "/admin/paper_manual_add?"+
    "&paper_name="+escapeHTML( paper_name )+"&paper_style="+paper_style+"&paper_type="+type+"&add_style="+add_style + "&paperStyleName=" + paperStyleName +"&perTimeRestrict="+limit_q_time;
}
