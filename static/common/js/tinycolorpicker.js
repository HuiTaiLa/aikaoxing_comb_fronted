...
(function($) {
  ...
  function Plugin($container, options) {
    ...
    this.setColor = function(color) {
      ...
      $color.find(".colorInner").show();
      $color.find(".colorInner").parent().find('img').hide();
      $color.find(".colorInner").parent().addClass('active');
      $('.pen-color div').removeClass('active');
      $color.find(".colorInner").parents('#colorPicker').addClass('active');
      $color.find(".colorInner").css("backgroundColor", self.colorHex);

      $colorInput.text(self.colorHex);
    };
