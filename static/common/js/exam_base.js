...
$(function () {
  ...
  $(function () {
    ...
    //所有带导航页面url结构列表
    var url_list = {
      "exam":["/depts/exam/history","/exam/wrong_topic"],
  ...
  $(function () {
    ...
    var search_list = [
      {url: 'exam/history', name: 'name', method: 'get', action: '/depts/exam/history_search',
        status: true},
  ...
  //知识库页面搜索禁用
  if(window.location.pathname != "/depts/exam/file_mgr") {
    //搜索
