      ...
      <div class="body-content">
          ...
          <div role="tabpanel" class="tab-area tab-col2">
            ...
            <ul class="ksx-tabs-card" role="tablist">
              <li class="ksx-tab-item">
                <a href="/admin/question_add_new/batch_import#/index" style="text-decoration: none">
                  批量录入
                </a>
              </li>
              ...
              <li class="ksx-tab-item">
                <a href="/admin/question_add_new/excel_import#/index/" style="text-decoration: none">
                  Excel导入
                </a>
              </li>
            </ul>
                ...
                <div role="tabpanel" class="tab-pane active" id="manualInput">
                  <div class="batch-type">
                    ...
                    <div class="simulationSelect testType">
                      <span class="title-font">单选题</span>
                  ...
                  <div class="question-content">
                    ...
                    <div class="keyRadio keyPanel">
                      ...
                      <div class="keyList">
                        <div class="keyLeft">
                          <input type="radio" class="radioOrCheck" name="keyChk">
                        </div>
                        <div class="keyRight keyRight1">
                            <div id="key1Editor" class="questions_add wangEditor-txt" contenteditable="true"
                                 style="height: 85px;"><p><br></p>
                            </div>
                      ...
                      <div class="keyList">
                        ...
                        <div class="keyRight keyRight2">
                            <div id="key2Editor" class="questions_add wangEditor-txt" contenteditable="true"
                                 style="height: 85px;"><p><br></p>
                            </div>
                          <input name="answer2" type="hidden">
                        </div>
                      </div>
                      <div class="keyList">
                        <div class="keyLeft">
                        ...
                        <div class="keyRight keyRight3">
                            <div id="key3Editor" class="questions_add wangEditor-txt" contenteditable="true"
                                 style="height: 85px;"><p><br></p>
                            </div>
                          <input name="answer3" type="hidden">
                        </div>
                      ...
                      <div class="keyList">
                        ...
                        <div class="keyRight keyRight4">
                            <div id="key4Editor" class="questions_add wangEditor-txt" contenteditable="true"
                                 style="height: 85px;"><p><br></p>
                            </div>
                          <input name="answer4" type="hidden">
                        </div>
                        <a href="javascript:void(0);" class="removeKey icons8-delete"></a>
                      </div>
                      <div class="addKeyBtn">
                    ...
                    <div class="keyFill keyPanel" style="display: none;">
                      ...
                      <div class="keyFillContent">
                        <div class="input-group">
                          <span class="input-group-addon">1</span>
                          <div class="bootstrap-tagsinput"><input type="text" placeholder="请输入答案，按下回车添加同义词。"></div>
                          <input type="text" name="keyFill" class="form-control" id="keyFillInput" data-role="tagsinput"
                                 placeholder="请输入答案，按下回车添加同义词。" style="display: none;">
                        </div>
                      </div>
        ...
        <div class="dialog-style-button" hidden="">
          <div class="body-toolbar-right toolbar-right-operation">
            <button type="button" class="btn btn-primary btn-size btn-reset">重置</button>
            <button type="button" class="btn btn-warning btn-size" id="saveAndAddButton">录入</button>
          </div>
        </div>
      </div>
    </div>
