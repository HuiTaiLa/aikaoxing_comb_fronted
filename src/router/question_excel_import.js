...
import QuestionExcelImportView from '@/components/admin/question_add_new/excel_import/QuestionExcelImportView'
...
let constRouter = [
  {
    path: '/',
    name: '试题添加',
    component: QuestionExcelImportView
  },
  {
    path: '/index',
    name: '试题添加',
...
let asyncRouter
let jumpView = "view:admin/question_add_new/excel_import"
// 导航守卫，渲染动态路由
