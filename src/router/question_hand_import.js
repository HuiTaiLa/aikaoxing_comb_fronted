...
import QuestionHandImportView from '@/components/admin/question_add_new/hand_import/QuestionHandImportView'
...
let constRouter = [
  {
    path: '/',
    name: '试题添加',
    component: QuestionHandImportView
  },
  {
    path: '/index',
    name: '试题添加',
...
let asyncRouter
let jumpView = "view:admin/question_add_new/hand_import"
// 导航守卫，渲染动态路由
