...
import QuestionBatchImportView from '@/components/admin/question_add_new/batch_import/QuestionBatchImportView'
...
let constRouter = [
  {
    path: '/index',
    name: '试题添加',
    component: QuestionBatchImportView
  },{
    path: '/',
    name: '试题添加',
    component: QuestionBatchImportView
...
let asyncRouter
let jumpView = "view:admin/question_add_new/batch_import"
